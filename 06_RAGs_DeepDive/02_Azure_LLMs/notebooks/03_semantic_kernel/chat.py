"""
This script demonstrates how to use the Semantic Kernel to interact with the Azure Chat API.

Source: https://github.com/alfredodeza/azure-chat-demo/blob/main/examples/1-simple/chat.py
